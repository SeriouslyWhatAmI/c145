...
canvas.create_rectangle(0, 0, 1920, 1080, fill="#F6091E")
...
def myLicense():
    id_value = 19837129738912378291379123712893712379812364864635823651231635127312312733531725372153613612321367213
    print(type(id_value))
    name = "hasdkjsadkjashdkjashdkjashdkasda"
    print(type(name)) 
    dob = "30 August 1423"
    print(type(dob))
    pin = 12345678987654321
    print(type(pin))
    address = "in the middle of nowhere, middle of nowhere"
    print(type(address))
    vehicle_type = ["One Trillion","Four"]
